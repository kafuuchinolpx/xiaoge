...
public class ZipUtil {
    ...
    * @param srcDir  原路径
    * @param zipFile  压缩文件
    * @param keepDirStructure  保存文件结构，不保存文件结构所有文件进入根目录，文件名冲突会报异常
    * @throws Exception
    */
    public static void toZip(String srcDir, String zipFile, boolean keepDirStructure) throws Exception {
